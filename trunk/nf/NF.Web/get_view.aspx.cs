...
namespace newsflippers {
    public partial class get_view : System.Web.UI.Page {
        protected void Page_Load(object sender, EventArgs e) {
            ...
            response = string.Format("{0};{1};{2};{3};{4};{5}", count.ToString(), selWebPage.Src, webpageList.Count.ToString(), selWebPage.Url, Util.RemoveImageExt(selWebPage.ImageName), selWebPage.Source);
